...
deepseek_bundle="${MODEL_DEEPSEEK_BUNDLE:-C:/models/deepseek-v4-flash/worker-bundle-v3}"
qwen_container="${MODEL_QWEN_CONTAINER:-C:/models/qwen3-next-80b-expert-pack-int8}"
